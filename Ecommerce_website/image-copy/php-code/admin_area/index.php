    ...
    <div class="container-fluid p-0 ">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-info">
            <div class="container-fluid">
                <img src="../images/images/logo.png.png"alt=""  class="logo">
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                <div class="p-3">
                    <a href="#"><img src="../images/images/juice-2189451_640.jpg" alt="admin_image" width="100" height="100"></a>
        ...
        <div class="bg-info p-3 text-center">
            <p>All rights reserved and designed by Jansi-2025</p>
        </div> 
    </div>
</div>    
